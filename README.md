...
## 💼 Business & Professional Overview (B2B Consulting)
...
*   **AWS Certified Solutions Architect – Associate (SAA)** — *Issued Jun 2026*
*   **HashiCorp Certified:** Terraform Associate — *Issued Feb 2026*
*   **GitHub Foundations Certification** — *Issued Feb 2026*
*   **AWS Certified Cloud Practitioner (CCP)** — *Issued Jan 2026*
*   **EXIN:** Privacy and Data Protection Essentials based on LGPD — *Issued Jun 2024*
*   **EXIN:** ISO 27001 Foundation — *Issued Nov 2023*
*   **Linux Professional Institute:** LPIC-1 Certification — *Issued Mar 2017*

---

## 📂 Active Security Portfolio & Projects

### 🔒 [PQC TLS Crypto-Agility Platform](https://github.com/tmmuniz/pqc-tls-agility-telemetry)
...
### 🛡️ [Cloud Security Automation Lab](https://github.com/tmmuniz/cloud-security-automation)
...
### ⚙️ [Cloud Compliance Pipeline](https://github.com/tmmuniz/cloud-compliance-pipeline)
...
## 📈 Executive & Technical Achievements
...
### **Soluti Digital – Certification Authority (ICP-Brasil)**
#### **Information Security Manager** *(Feb 2022 – Jan 2026)*
...
#### **Infrastructure Analyst** *(Nov 2015 – Jan 2022)*
...
*   **M.Sc. in Computer Engineering (Professional Master's)** — *IPT (Instituto de Pesquisas Tecnológicas do Estado de SP)* | *2017 – 2020*
...
*   **Postgraduate Specialization in Computer Networks & System Security** — *UFG (Universidade Federal de Goiás)* | *2015 – 2017*
    *   **Research Highlight:** Engineered hybrid-identity encryption using challenge-response, nonces, and one-time pads.
*   **Technology Degree in Computer Networks** — *FATESG* | *2010 – 2013*
